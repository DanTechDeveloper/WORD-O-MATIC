        ...
        <DashboardLayout>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
                ...
                <div className="space-y-6">
                    ...
                    <div
                        className="bg-slate-950 rounded-[2.5rem] border-4 border-slate-800 p-8 shadow-[8px_8px_0_0_#020617] min-h-[400px] max-h-[600px] overflow-y-auto 
                            ...
                            <div key={i} className="mb-8 last:mb-0">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {level.mastered.map((word, j) => (
                                        <span
                                            key={j}
                                            className="px-4 py-2 bg-slate-900 border-2 border-slate-800 text-white font-black rounded-xl text-sm hover:border-lime-400 transition-colors cursor-default"
                                        >
                                            {word}
                                        </span>
                                    ))}
                            ...
                            <div key={i} className="mb-8 last:mb-0">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {level.training.map((word, j) => (
                                        <span
                                            key={j}
                                            className="px-4 py-2 bg-slate-900 border-2 border-slate-800 text-slate-400 font-black rounded-xl text-sm hover:border-orange-400 transition-colors cursor-default"
                                        >
                                            {word}
                                        </span>
                                    ))}

            ...
            {gameState === "IDLE" && (
                <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm z-40 pointer-events-none flex flex-col items-center justify-end pb-36 sm:pb-48">
                    <div className="flex flex-col items-center justify-center animate-bounce">
                        <div className="bg-sky-400 text-slate-950 font-black px-8 py-4 rounded-[2rem] shadow-[0_0_40px_rgba(56,189,248,0.4)] border-4 border-white flex flex-col items-center gap-1 text-center italic uppercase tracking-tighter">

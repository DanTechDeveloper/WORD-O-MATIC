...
export default function Login() {
    const [fullNameOrId, setFullNameOrId] = useState("");
    const [pin, setPin] = useState("");

    const handleLogin = () => {
        if (fullNameOrId.trim() && pin.trim()) {
            // In a real application, you would send fullNameOrId and pin to an authentication endpoint.
            // For this UI refactor, we'll simulate passing the name to the next page,
            // as the original component did with searchQuery.
            router.visit("/student/welcome", {
                method: "get",
                data: { name: fullNameOrId.trim() }, // Pass the entered name
            });
        } else {
            // Provide user feedback for empty fields
            alert("Please enter your Full Name or ID and PIN to log in.");
        }
    };
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <input
                                ...
                                value={fullNameOrId}
                                onChange={(e) =>
                                    setFullNameOrId(e.target.value)
                                }

                    ...
                    >
                        ...
                        <header class="text-center mb-10">
                            ...
                            <p class="text-lg md:text-xl font-bold text-zinc-400 uppercase tracking-widest">
                                The robots are confused... Can you help them
                                talk?
                            </p>
                        </header>
                        {/* <!-- BEGIN: LoginForm --> */}
                        <form
                            action="#"
                            class="space-y-8"
                            onsubmit="event.preventDefault(); alert('Adventure Starting!');"
                        >
                            {/* <!-- Name Field Group --> */}
                            <div class="flex flex-col gap-3">
                                ...
                                <input
                                    class="w-full p-5 text-xl font-semibold rounded-2xl border-4 border-zinc-800 bg-zinc-950 text-white placeholder-zinc-600 focus:border-lime-400 focus:ring-0 transition-all outline-none tactile-input"
                                    id="student-name"

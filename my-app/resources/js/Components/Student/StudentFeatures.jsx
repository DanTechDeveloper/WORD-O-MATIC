    ...
    return (
        <>
            <nav className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 pb-6 pt-2 h-24 bg-slate-950 border-t-4 border-purple-900 rounded-t-3xl shadow-[0px_-6px_0px_0px_rgba(88,28,135,1)]">
                ...
                <Link
                    className={getLinkClasses("/leaderboards")}
                    href="/leaderboards"
                >
                    <span className="material-symbols-outlined text-2xl" style={{ fontVariationSettings: `'FILL' ${url.startsWith("/leaderboards") ? 1 : 0}` }}>
                        leaderboard
                    </span>
                    <span className="font-['Lexend'] text-[10px] font-black uppercase">
                        Leaderboard
                ...
                <Link
                    className={getLinkClasses("/badges")}
                    href="/badges"
                >
                    <span className="material-symbols-outlined text-2xl" style={{ fontVariationSettings: `'FILL' ${url.startsWith("/badges") ? 1 : 0}` }}>
                        military_tech
                    </span>
                    <span className="font-['Lexend'] text-[10px] font-black uppercase">
                        Badges

export default function StatTile({ label, value, valueClassName = "text-accent", note }) {
    return (
        <div className="flex-1 bg-surface-container rounded-xl py-6 px-4 text-center border border-outline/20">

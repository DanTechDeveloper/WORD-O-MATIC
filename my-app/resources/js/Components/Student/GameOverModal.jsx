            ...
            <div className="relative bg-white/5 backdrop-blur-3xl p-6 sm:p-8 md:p-12 rounded-[2.5rem] sm:rounded-[3rem] md:rounded-[3.5rem] border-2 border-white/10 shadow-2xl max-w-md text-center overflow-hidden">
                <div className="relative z-10">
                    ...
                    parseFloat(accuracy) >= 100 ? (
                        <h2 className="text-white text-2xl sm:text-3xl md:text-4xl font-black uppercase mb-3 sm:mb-4">
                            PERFECT!
                        </h2>
                    ) : gameState === "COMPLETED" ? (
                        <h2 className="text-white text-2xl sm:text-3xl md:text-4xl font-black uppercase mb-3 sm:mb-4">
                    ...
                    <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 md:mb-10 text-left">
                        <p className="text-white text-lg sm:text-xl md:text-2xl font-black">
                            Words Smashed:{" "}
                    ...
                    <div className="flex flex-col gap-3 sm:gap-4">
                        <button
                            onClick={onPlayAgain}
                            className="w-full bg-lime-400 text-slate-950 text-lg sm:text-xl md:text-2xl font-black py-4 sm:py-5 md:py-6 rounded-2xl uppercase"
                        >
                            Play Again
                        </button>
                        ...
                        <Link
                            href={backToMapUrl}
                            className="w-full bg-white/5 border-2 border-white/10 text-white text-base sm:text-lg md:text-xl font-black py-3 sm:py-4 md:py-5 rounded-2xl uppercase"
                        >
                            Back To Map
                        </Link>
                    </div>

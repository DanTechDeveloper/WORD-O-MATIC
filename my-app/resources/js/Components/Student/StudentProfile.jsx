...
export default function StudentProfile() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 h-16 lg:h-20 flex items-center justify-between px-4 lg:px-8 z-40 bg-slate-950 border-b-4 border-purple-900 shadow-[0_4px_0_0_#1e1b4b]">

...
// ponytail: generalized to reuse for CLEAR deadline — student prop kept for backward-compat (tests + Students.jsx)
import { useEffect } from "react";

export default function ConfirmDeleteModal({ isOpen, student, onClose, onConfirm, title, message, confirmText, confirmIcon, variant }) {
    useEffect(() => {
        if (!isOpen) return;
    ...
    if (!isOpen || !hasContent) return null; // if (!isOpen || !student) return null — kept for test compat, now hasContent covers generic message
